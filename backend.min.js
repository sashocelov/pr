    ...
    _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function() {
        ...
        prepareContentBlock: function() {
            this.$content = this.notRequestTemplate ? this.$el : this.$el.find(this.contentSelector).removeClass("vc_with-tabs"),
                this.$content.empty(), this.$spinner = $('<span class="vc_ui-wp-spinner vc_ui-wp-spinner-lg"></span>'), this.$content.prepend(this.$spinner)
        },
        ...
        save: function() {
            if (this.panelInit) {
                var params;
                params = _.extend({}, vc.getDefaults(this.model.get("shortcode")), this.getParams()), this.model.save({
                    params: params
                }), this.showMessage(window.sprintf(window.i18nLocale.inline_element_saved, vc.getMapped(this.model.get("shortcode")).name), "success"), !vc.frame_window && this.hide(), this.trigger("save")
            }
        },
        show: function() {
        ...
        builder: function() {
            return this._builder || (this._builder = new vc.ShortcodesBuilder),
                this._builder
        },
...
function($) {
    ...
    vc.TemplateWindowUIPanelBackendEditor = vc.TemplatesPanelViewBackend.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperTemplatesPanelViewSearch).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).extend({
        ...
        showMessage: function(text, type) {
            ...
            var $messageBox, messageBoxTemplate = _.template('<div class="vc_message_box vc_message_box-standard vc_message_box-rounded vc_color-<%- color %>"><div class="vc_message_box-icon"><i class="fa fa fa-<%- icon %>"></i></div><p><%- text %></p></div>');
            switch (type) {
                case "error":
        ...
        showMessage: function(text, type) {
            ...
            var $messageBox, wrapperCssClasses, messageBoxTemplate = _.template('<div class="vc_message_box vc_message_box-standard vc_message_box-rounded vc_color-<%- color %>"><div class="vc_message_box-icon"><i class="fa fa fa-<%- icon %>"></i></div><p><%- text %></p></div>');
    ...
    function($) {
        $.expr[":"].containsi = function(a, i, m) {
            ...
            e.preventDefault(), window.setCookie("vchideactivationmsg", 1, 14), $(this).parent().slideUp()
        })
    }(window.jQuery);
...
window.vc.filters = {
    ...
    function($) {
        ...
        var VcLoopEditorView = Backbone.View.extend({
                ...
                render: function(controller) {
                    var template = _.template($("#vcl-loop-frame").html(), this.model, _.extend({}, template_options, {
                        variable: "loop"
                    }));
                    return this.controller = controller, this.$el.html(template), this.controller.$el.append(this.$el), _.each($("[data-suggest]"), function(object) {
                        var $field = $(object),
                ...
                updateSuggestion: function($elem, data) {
                    ...
                    value = _.reduce(data, function(memo, label) {
                        return _.isEmpty(label) ? void 0 : memo + (_.isEmpty(memo) ? "" : ",") + ("-" === label.action ? "-" : "") + label.value
                ...
                suggestionLocked: function($elem, data) {
                    ...
                    return this.controller.settings[field] && _.isBoolean(this.controller.settings[field].locked) && 1 == this.controller.settings[field].locked && _.isString(this.controller.settings[field].value) && 0 <= _.indexOf(this.controller.settings[field].value.replace("-", "").split(/\,/), "" + value)
                }
            }),
            ...
            VcOptionsField = Backbone.View.extend({
                ...
                render: function() {
                    ...
                    return _.each(this.settings, function(field) {
                        ...
                        $field.is("script") && (html += _.template($field.html(), $.extend({
                            name: "",
                            label: "",
                            value: [],
                            options: "",
                            description: ""
                        }, field), _.extend({}, template_options)))
            ...
            VC_AutoComplete = Backbone.View.extend({
                ...
                labelRemoveClick: function(e, ui) {
                    ...
                    var $label = $(e.currentTarget),
                        index = parseInt($label.data("index"), 10),
                        $target = $(e.target);
                    return $target.is(".vc_autocomplete-remove") ? (delete this.selected_items[index], $label.remove(), this.updateItems(), this.$el.show(), !1) : void 0
                },
        ...
        vc.edit_form_callbacks = [], vc.atts = {
            ...
            init: function(param, $field) {
                $(".vc_link-build", $field).click(function(e) {
                    ...
                    e.preventDefault(), $block = $(this).closest(".vc_link"), $input = $block.find(".wpb_vc_param_value"), $url_label = $block.find(".url-label"), $title_label = $block.find(".title-label"), value_object = $input.data("json"), $link_submit = $("#wp-link-submit"), $vc_link_submit = $('<input type="submit" name="vc_link-submit" id="vc_link-submit" class="button-primary" value="Set Link">'), $link_submit.hide(), $("#vc_link-submit").remove(), $vc_link_submit.insertBefore($link_submit), dialog = !window.wpLink && $.fn.wpdialog && $("#wp-link").length ? {
                    ...
                    } : window.wpLink, dialog.open("content"), _.isString(value_object.url) && ($("#wp-link-url").length ? $("#wp-link-url").val(value_object.url) : $("#url-field").val(value_object.url)), _.isString(value_object.title) && ($("#wp-link-text").length ? $("#wp-link-text").val(value_object.title) : $("#link-title-field").val(value_object.title)), $("#wp-link-target").length ? $("#wp-link-target").prop("checked", !_.isEmpty(value_object.target)) : $("#link-target-checkbox").prop("checked", !_.isEmpty(value_object.target)), $vc_link_submit.unbind("click.vcLink").bind("click.vcLink", function(e) {
                        ...
                        return options.target = $checkbox[0].checked ? " _blank" : "", string = _.map(options, function(value, key) {
                            return _.isString(value) && 0 < value.length ? key + ":" + encodeURIComponent(value) : void 0
                        }).join("|"), $input.val(string), $input.data("json", options), $url_label.html(options.url + options.target), $title_label.html(options.title), dialog.close(), $link_submit.show(), $vc_link_submit.unbind("click.vcLink"), $vc_link_submit.remove(), $("#wp-link-cancel").unbind("click.vcLink"), window.wpLink.textarea = "", $checkbox.attr("checked", !1), !1
        ...
        vc.debug = !1, vc.map = _.isUndefined(window.vc_mapper) ? {} : window.vc_mapper, vc.roles = _.isUndefined(window.vc_roles) ? {} : window.vc_roles, vc.Storage = function() {
            ...
            storageCreateShortcodeString: function(model) {
                ...
                return tag = model.get("shortcode"), params = _.extend({}, model.get("params")), paramsForString = {}, mergedParams = vc.getMergedParams(tag, params), _.each(mergedParams, function(value, key) {
                    "content" !== key && (paramsForString[key] = this.escapeParam(value))
            ...
            wrapData: function(content) {
                var tags = _.keys(vc.map).join("|"),
                    ...
                    matches = _.filter(content.trim().split(reg), function(value) {
                        return _.isEmpty(value) ? void 0 : value
                    });
                return content = _.reduce(matches, function(mem, value) {
                    value.trim().match(starts_with_shortcode) || (value = "[vc_row][vc_column][vc_column_text]" + value + "[/vc_column_text][/vc_column][/vc_row]");
                    var matches_local = value.match(vc_regexp_shortcode());
                    return !_.isArray(matches_local) || _.isUndefined(matches_local[2]) || _.isUndefined(vc.map[matches_local[2]]) || !_.isUndefined(vc.map[matches_local[2]].is_container) && vc.map[matches_local[2]].is_container || !_.isEmpty(vc.map[matches_local[2]].as_parent) || (value = "[vc_row][vc_column]" + value + "[/vc_column][/vc_row]"), mem + value
                }, "")
            },
            fetch: function() {
    ...
    function($) {
        ...
        vc.shortcode = Backbone.Model.extend({
            ...
            createFromString: function(shortcodes_string, parent_model) {
                var data;
                data = vc.storage.parseContent({}, shortcodes_string, _.isObject(parent_model) ? parent_model.toJSON() : !1), _.each(_.values(data), function(model) {
                    vc.shortcodes.create(model)
                }, this)
            },
            sync: function(method, model, options) {
            ...
            createShortcodeString: function(model, state) {
                var mapped, data, tag, params, content, paramsForString, mergedParams, isContainer;
                return tag = model.get("shortcode"), params = _.extend({}, model.get("params")), paramsForString = {}, mergedParams = vc.getMergedParams(tag, params), _.each(mergedParams, function(value, key) {
                    "content" !== key && (paramsForString[key] = vc.storage.escapeParam(value))
            ...
            return defaults = {}, params = _.isObject(vc.map[tag]) && _.isArray(vc.map[tag].params) ? vc.map[tag].params : [], _.each(params, function(param) {
                _.isObject(param) && (_.isUndefined(param.std) ? _.isUndefined(param.value) || (vc.atts[param.type] && vc.atts[param.type].defaults ? defaults[param.param_name] = vc.atts[param.type].defaults(param) : _.isObject(param.value) ? defaults[param.param_name] = _.values(param.value)[0] : _.isArray(param.value) ? defaults[param.param_name] = param.value[0] : defaults[param.param_name] = param.value) : defaults[param.param_name] = param.std)
            }), defaults
            ...
            return params = _.isObject(vc.map[tag]) && _.isArray(vc.map[tag].params) ? vc.map[tag].params : [], paramSettings = _.find(params, function(settings) {
        ...
        vc.saved_custom_css = !1, vc.visualComposerView = Backbone.View.extend({
            ...
            initialize: function() {
                ...
                _.bindAll(this, "switchComposer", "dropButton", "processScroll", "updateRowsSorting", "updateElementsSorting"), this.accessPolicy = vc.accessPolicy, this.buildRelevance(), vc.events.on("shortcodes:add", vcAddShortcodeDefaultParams, this), vc.events.on("shortcodes:add", vc.atts.addShortcodeIdParam, this), vc.events.on("shortcodes:sync", vc.atts.addShortcodeIdParam, this), vc.events.on("shortcodes:add", this.addShortcode, this), vc.events.on("shortcodes:destroy", this.checkEmpty, this), vc.shortcodes.on("change:params", this.changeParamsEvents, this), vc.shortcodes.on("reset", this.addAll, this), $(document).on("wp-collapse-menu", function(e, params) {
                    "open" === params.state && self.leaveFullscreen()
                }), this.render()
            },
            ...
            addChild: function(parent_id) {
                _.each(vc.shortcodes.where({
                    ...
                    this.appendShortcode(shortcode), this.setSortable(), this.addChild(shortcode.get("id"))
                }, this)
            },
            ...
            appendShortcode: function(model) {
                ...
                if (view = this.getView(model), params = _.extend(vc.getDefaults(model.get("shortcode")), model.get("params")), model.set("params", params, {
                        silent: !0
                    }), parentModelView = !1 !== model.get("parent_id") ? this.views[model.get("parent_id")] : !1, this.views[model.id] = view, model.get("parent_id")) {
                    var parentView;
            ...
            addShortcode: function(model) {
                ...
                if (params = _.extend(vc.getDefaults(model.get("shortcode")), model.get("params")), model.set("params", params, {
                        silent: !0
                    }), view = this.getView(model), parentModelView = !1 !== model.get("parent_id") ? this.views[model.get("parent_id")] : !1, view.use_default_content = !0 !== model.get("cloned"), this.views[model.id] = view, parentModelView) {
                    parentModelView.addShortcode(view), parentModelView.checkIsEmpty();
                    var self;
                    self = this, _.defer(function() {
                        view.changeShortcodeParams && view.changeShortcodeParams(model), view.ready(), self.setSortable(), self.setNotEmpty()
                    })
            ...
            addTextBlock: function(e) {
                ...
                return e.preventDefault(), row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), row = vc.shortcodes.create({
                    ...
                    parent_id: row.id,
                    root_id: row.id
                }), params = vc.getDefaults("vc_column_text"), "undefined" != typeof window.vc_settings_presets.vc_column_text && (params = _.extend(params, window.vc_settings_presets.vc_column_text)), vc.shortcodes.create({
            ...
            createRow: function() {
                ...
                return row_params = {}, "undefined" != typeof window.vc_settings_presets.vc_row && (row_params = _.extend(row_params, window.vc_settings_presets.vc_row)), row = vc.shortcodes.create({
                    shortcode: "vc_row",
                    params: row_params
                }), column_params = {
                    width: "1/1"
                }, "undefined" != typeof window.vc_settings_presets.vc_column && (column_params = _.extend(column_params, window.vc_settings_presets.vc_column)), vc.shortcodes.create({
                    shortcode: "vc_column",
                    params: column_params,
                    parent_id: row.id,
                    root_id: row.id
                ...
                _.defer(function(app, event, ui) {
                    ...
                    if (!_.isNull(ui.sender)) {
                        ...
                        vc.storage.lock(), model.save({
                            parent_id: parent.id
                        }), app.views[old_parent_id].checkIsEmpty(), app.views[parent.id].checkIsEmpty()
                    }
            ...
            updateRowsSorting: function() {
                _.defer(function(app) {
                    ...
                    $rows.each(function() {
                        ...
                        $rows.length - 1 > index && vc.storage.lock(), $(this).data("model").save({
                            order: index
                        })
                    })
                }, this)
            ...
            renderPlaceholder: function(event, element) {
                var tag = $(element).data("element_type"),
                    ...
                    $helper = $('<div class="vc_helper vc_helper-' + tag + '"><i class="vc_general vc_element-icon' + (vc.map[tag].icon ? " " + vc.map[tag].icon : "") + '"' + (is_container ? ' data-is-container="true"' : "") + "></i> " + vc.map[tag].name + "</div>").prependTo("body");
                return $helper
            },
            rowSortableSelector: "> .wpb_vc_row",
            setSortable: function() {
                return $(".wpb_main_sortable").sortable({
                    ...
                    stop: function(event, ui) {
                        ...
                        var tag = ui.item.data("element_type"),
                            ...
                            allowed_container_element = _.isUndefined(vc.map[parent_tag].allowed_container_element) ? !0 : vc.map[parent_tag].allowed_container_element;
                        vc.check_relevance(parent_tag, tag) || $(this).sortable("cancel");
                        ...
                        is_container && !0 !== allowed_container_element && allowed_container_element !== ui.item.data("element_type").replace(/_inner$/, "") && $(this).sortable("cancel"), $(".vc_sorting-empty-container").removeClass("vc_sorting-empty-container")
                    },
                    ...
                    over: function(event, ui) {
                        var tag = ui.item.data("element_type"),
                            ...
                            allowed_container_element = _.isUndefined(vc.map[parent_tag].allowed_container_element) ? !0 : vc.map[parent_tag].allowed_container_element;
                        if (!vc.check_relevance(parent_tag, tag)) return ui.placeholder.addClass("vc_hidden-placeholder"), !1;
                        var is_container = _.isObject(vc.map[tag]) && (_.isBoolean(vc.map[tag].is_container) && !0 === vc.map[tag].is_container || !_.isEmpty(vc.map[tag].as_parent));
            ...
            processScroll: function(e) {
                return !0 === this.disableFixedNav ? void this.$nav.removeClass("vc_subnav-fixed") : ((!this.navTop || 0 > this.navTop) && this.setNavTop(), this.scrollTop = $(window).scrollTop() + 80, void(0 < this.navTop && this.scrollTop >= this.navTop && !this.isFixed ? (this.isFixed = 1, this.$nav.addClass("vc_subnav-fixed")) : this.scrollTop <= this.navTop && this.isFixed && (this.isFixed = 0, this.$nav.removeClass("vc_subnav-fixed"))))
            },
    ...
    function($) {
        ...
        window.VcRowView = vc.shortcode_view.extend({
            ...
            ready: function(e) {
                return window.VcColumnView.__super__.ready.call(this, e), this.setDropable(), this
            },
            render: function() {
            ...
            changeShortcodeParams: function(model) {
                ...
                window.VcAccordionView.__super__.changeShortcodeParams.call(this, model), params = model.get("params"), collapsible = _.isString(params.collapsible) && "yes" === params.collapsible ? !0 : !1, this.$content.hasClass("ui-accordion") && this.$content.accordion("option", "collapsible", collapsible)
            },
            changedContent: function(view) {
            ...
            addTab: function(e) {
                return e.preventDefault(), vc_user_access().shortcodeAll("vc_accordion_tab") ? (this.adding_new_tab = !0, void vc.shortcodes.create({
            ...
            changeShortcodeParams: function(model) {
                var params;
                if (window.VcButton2View.__super__.changeShortcodeParams.call(this, model),
                    params = model.get("params"), _.isObject(params)) {
                    var el_class;
            ...
            changeShortcodeParams: function(model) {
                var params;
                if (window.VcButton3View.__super__.changeShortcodeParams.call(this, model), params = _.extend({}, model.get("params")), this.buttonTemplate || (this.buttonTemplate = this.$el.find(".vc_btn3-container").html()), this.$wrapper || (this.$wrapper = this.$el.find(".wpb_element_wrapper")), _.isObject(params)) {
                    ...
                    var $element = $(_.template(this.buttonTemplate, {
                        params: params
            ...
            updateSorting: function(event, ui) {
                var self;
                return vc_user_access().shortcodeAll("vc_tta_section") ? (self = this, this.$sortable.find(this.sortableSelector).each(function() {
            ...
            replaceTemplateVars: function() {
                ...
                title = this.model.getParam("title"), _.isEmpty(title) && (title = this.parentObj && this.parentObj.defaultSectionTitle && this.parentObj.defaultSectionTitle.length ? this.parentObj.defaultSectionTitle : window.i18nLocale.section), $panelHeading = this.$el.find(".vc_tta-panel-heading"), $panelHeading.html(_.template($panelHeading.html(), {
    ...
    function($, _) {
        ...
        var attachmentCompatRender, media = wp.media,
        ...
        attachmentCompatRender = _.extend(media.view.AttachmentCompat.prototype.render), media.view.AttachmentCompat.prototype.render = function() {
            ...
            set: function(selection) {
                return this.$img_ul.html(_.template($("#vc_settings-image-block").html(), selection, templateSettings)), this.$clear_button.show(), this.$hidden_ids.val(selection.id).trigger("change"), !1
            },
